...
/**
 * ================================================================================================
 * 🆕 NEW UPGRADES SUMMARY (v1.0 - STUDY ROOM ORCHESTRATOR)
 * ================================================================================================
 * 1. 4-STAGE MACHINE: Utilizes identical flow (Customization -> Loading -> Session -> Results) 
 *    with active learning capabilities.
 * 2. MODE PROP TRIGGER: Hardcoded `mode="study"` to trigger the purple UI, 1-subject limit, 
 *    custom question count, and AI real-time explanations logic in the core components.
 * ================================================================================================
 */
